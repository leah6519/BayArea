...
```{r example-plot, echo = TRUE, message=FALSE, warning=FALSE, fig.align="center", out.width="70%", fig.cap = "A scatterplot showing the areas where the flock Dark eyed Juncoes (Juncos?) were spotted in 2010 vs 2011"}
edited_2010 <- birds %>% 
  filter(year == 2010) %>%
